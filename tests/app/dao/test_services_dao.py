...
def test_create_service_returns_service_with_default_permissions(notify_db_session):
    ...
    _assert_service_permissions(
        service.permissions,
        (SMS_TYPE, EMAIL_TYPE, LETTER_TYPE, INTERNATIONAL_SMS_TYPE, INTERNATIONAL_LETTERS, MESSAGEBOX_TYPE),
    )
...
@pytest.mark.parametrize(
    ...
    [
        (SMS_TYPE, (EMAIL_TYPE, LETTER_TYPE, INTERNATIONAL_SMS_TYPE, INTERNATIONAL_LETTERS, MESSAGEBOX_TYPE)),
        (EMAIL_TYPE, (SMS_TYPE, LETTER_TYPE, INTERNATIONAL_SMS_TYPE, INTERNATIONAL_LETTERS, MESSAGEBOX_TYPE)),
    ],
)
...
def test_removing_all_permission_returns_service_with_no_permissions(notify_db_session):
    ...
    dao_remove_service_permission(service_id=service.id, permission=MESSAGEBOX_TYPE)
...
def test_create_service_by_id_adding_and_removing_letter_returns_service_without_letter(service_factory):
    ...
    _assert_service_permissions(
        service.permissions, (SMS_TYPE, EMAIL_TYPE, INTERNATIONAL_SMS_TYPE, INTERNATIONAL_LETTERS, MESSAGEBOX_TYPE)
    )
