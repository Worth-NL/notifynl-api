...
def internal_jwt_token(notify_api):
    with set_config_values(
        ...
        yield create_jwt_token(client_id="my-internal-app", secret="my-internal-app-secret")
...
def test_requires_auth_should_cache_service_and_api_key_lookups(mocker, client, service_jwt_token):
