...
# Notification report request status mapping
NOTIFICATION_REQUEST_REPORT_SENDING = "sending"
NOTIFICATION_REQUEST_REPORT_FAILED = "failed"
NOTIFICATION_REQUEST_REPORT_DELIVERED = "delivered"
NOTIFICATION_REQUEST_REPORT_ALL = "all"

NOTIFICATION_REQUEST_REPORT_SENDING_STATUSES = [
    NOTIFICATION_CREATED,
    NOTIFICATION_PENDING,
    NOTIFICATION_PENDING_VIRUS_CHECK,
    NOTIFICATION_SENDING,
]
NOTIFICATION_REQUEST_REPORT_DELIVERED_STATUSES = [
    NOTIFICATION_DELIVERED,
    NOTIFICATION_RETURNED_LETTER,
    NOTIFICATION_SENT,
]
NOTIFICATION_REQUEST_REPORT_FAILURE_STATUSES = [
    NOTIFICATION_FAILED,
    NOTIFICATION_PERMANENT_FAILURE,
    NOTIFICATION_TECHNICAL_FAILURE,
    NOTIFICATION_TEMPORARY_FAILURE,
...
NOTIFICATION_REQUEST_REPORT_ALL_STATUSES = (
    NOTIFICATION_REQUEST_REPORT_SENDING_STATUSES
    + NOTIFICATION_REQUEST_REPORT_DELIVERED_STATUSES
    + NOTIFICATION_REQUEST_REPORT_FAILURE_STATUSES
)

NOTIFICATION_REPORT_REQUEST_MAPPING = {
    NOTIFICATION_REQUEST_REPORT_ALL: NOTIFICATION_REQUEST_REPORT_ALL_STATUSES,
    NOTIFICATION_REQUEST_REPORT_DELIVERED: NOTIFICATION_REQUEST_REPORT_DELIVERED_STATUSES,
    NOTIFICATION_REQUEST_REPORT_FAILED: NOTIFICATION_REQUEST_REPORT_FAILURE_STATUSES,
    NOTIFICATION_REQUEST_REPORT_SENDING: NOTIFICATION_REQUEST_REPORT_SENDING_STATUSES,
}
...
POSTAGE_TYPES = [NETHERLANDS, EUROPE, REST_OF_WORLD]
UK_POSTAGE_TYPES = [NETHERLANDS]
INTERNATIONAL_POSTAGE_TYPES = [EUROPE, REST_OF_WORLD]

DEFAULT_POSTAGE = NETHERLANDS
...
ALL_TYPE = "all"
TEMPLATE_TYPES = [SMS_TYPE, EMAIL_TYPE, LETTER_TYPE, MESSAGEBOX_TYPE]
NOTIFICATION_TYPES = [SMS_TYPE, EMAIL_TYPE, LETTER_TYPE, MESSAGEBOX_TYPE]
NOTIFICATION_TYPE = [EMAIL_TYPE, SMS_TYPE, LETTER_TYPE, MESSAGEBOX_TYPE]  # duplicate that can probably be cleaned up
...
BRANDING_ALIGNMENT_LEFT = "left"
BRANDING_ALIGNMENT_CENTER = "center"
BRANDING_ALIGNMENT_RIGHT = "right"
BRANDING_ALIGNMENTS = [BRANDING_ALIGNMENT_LEFT, BRANDING_ALIGNMENT_CENTER, BRANDING_ALIGNMENT_RIGHT]
...
SPRYNG_PROVIDER = "spryng"
SES_PROVIDER = "ses"
SMS_PROVIDERS = [MMG_PROVIDER, FIRETEXT_PROVIDER, SPRYNG_PROVIDER]
